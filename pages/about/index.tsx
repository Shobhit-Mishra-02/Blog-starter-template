    ...
    <div className="w-full">
      ...
      <div className="pt-20 px-1 sm:flex sm:justify-center sm:align-middle sm:items-center sm:space-x-2 md:justify-evenly lg:justify-center lg:space-x-12 md:pt-48 ">
        ...
        <div className="sm:max-w-sm lg:max-w-md xl:max-w-xl">
          ...
          <p className="text-center text-gray-500 sm:text-left">
            ...
            nemo eius aliquid eaque. Aliquid accusantium consectetur,
            praesentium amet cumque, ab reiciendis iusto autem, incidunt
            excepturi at iure eius est. Lorem, ipsum dolor sit amet consectetur
            adipisicing elit. Nulla porro odio libero deleniti laudantium harum
            nihil alias, ratione rem velit, placeat iste culpa dolore a id neque
            aut similique ab.
          </p>
      ...
      <div className="px-2 sm:max-w-sm sm:mx-auto sm:pt-12 md:max-w-xl lg:max-w-4xl md:pt-24">
        ...
        <p className="text-center text-gray-500 md:text-left">
          ...
          pariatur illo delectus aperiam, ut inventore eaque consectetur et
          ullam odio suscipit? Vero hic nemo, animi sunt optio suscipit commodi
          ex? Lorem ipsum, dolor sit amet consectetur adipisicing elit.
          Deserunt, vero iste? Culpa ab laudantium explicabo. Officia
          reprehenderit voluptatibus debitis. Autem veniam labore incidunt
          mollitia voluptates, aperiam sed delectus alias dolor.
        </p>
