      ...
      <div className="pt-12 flex flex-wrap flex-row-reverse md:justify-evenly md:align-middle md:items-center md:px-6">
        ...
        <div className="pt-6 md:max-w-sm lg:max-w-md xl:max-w-xl">
          ...
          <p className="text-gray-500 text-center pt-6 md:text-left lg:text-sm">
            ...
            reprehenderit suscipit aperiam atque. Dolores, magni consequatur qui
            repellendus totam, ullam eligendi ratione harum placeat fugit,
            tempora rem pariatur aliquam. Lorem ipsum dolor sit amet consectetur
            adipisicing elit. Tempora ullam nam quod nisi cumque sequi voluptas
            quas nobis consequuntur, facere
          </p>
          ...
          <div className="px-2 max-w-sm md:flex md:max-w-[700px] lg:max-w-[1200px]">
            ...
            <div className="pt-2 px-1 md:max-w-sm md:rounded-md md:shadow-xl md:shadow-gray-300 md:translate-y-20 md:-translate-x-20 md:border bg-white md:h-fit md:py-2 md:px-2 lg:translate-y-36 xl:translate-y-44 lg:py-4 lg:px-4 lg:max-w-lg">
              ...
              <p className="text-sm text-gray-500">
                ...
                Pariatur, voluptates numquam? Laborum sed quibusdam perferendis
                ab laboriosam enim saepe praesentium odio id ex sequi inventore
                recusandae eum voluptatibus, aperiam eaque. Lorem ipsum dolor
                sit amet consectetur adipisicing elit. Doloremque provident
                velit consequuntur repudiandae
              </p>
